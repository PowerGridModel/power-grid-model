...
SingleColumnarData = dict[ComponentAttributeVar, SingleColumn]
...
DenseBatchColumnarData = dict[ComponentAttributeVar, BatchColumn]
...
Component = dict[ComponentAttributeVar, AttributeValue | str]
