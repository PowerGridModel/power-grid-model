...
from power_grid_model._core.dataset_definitions import ComponentAttribute, DatasetType
...
class ValidationError(ABC):
    ...
    field: ComponentAttribute | list[ComponentAttribute] | list[tuple[ComponentType, ComponentAttribute]] | None = None
    """
    ...
    def field_str(self) -> str:
        ...
        def _unpack(field: ComponentAttribute | tuple[ComponentType, ComponentAttribute]) -> str:
...
class SingleFieldValidationError(ValidationError):
    ...
    def __init__(self, component: ComponentType, field: ComponentAttribute, ids: Iterable[int] | None):
        """
        Args:
...
class MultiFieldValidationError(ValidationError):
    ...
    component: ComponentType
    field: list[ComponentAttribute]
    ids: list[int]

    def __init__(self, component: ComponentType, fields: list[ComponentAttribute], ids: list[int]):
        """
        Args:
            component: Component name
...
class MultiComponentValidationError(ValidationError):
    ...
    field: list[tuple[ComponentType, ComponentAttribute]]
    ids: list[tuple[ComponentType, int]]
    _message = "Fields {field} are not valid for {n} {objects}."

    def __init__(self, fields: list[tuple[ComponentType, ComponentAttribute]], ids: list[tuple[ComponentType, int]]):
        """
        Args:
...
class NotIdenticalError(SingleFieldValidationError):
    ...
    def __init__(self, component: ComponentType, field: ComponentAttribute, ids: Iterable[int], values: list[Any]):
...
class InvalidValueError(SingleFieldValidationError):
    ...
    def __init__(self, component: ComponentType, field: ComponentAttribute, ids: list[int], values: list):
        super().__init__(component, field, ids)
        self.values = values
...
class InvalidEnumValueError(SingleFieldValidationError):
    ...
    def __init__(
        self, component: ComponentType, field: ComponentAttribute, ids: list[int], enum: type[Enum] | list[type[Enum]]
    ):
        super().__init__(component, field, ids)
        self.enum = enum
...
class IdNotInDatasetError(SingleFieldValidationError):
    ...
    def __init__(self, component: ComponentType, ids: list[int], ref_dataset: DatasetType):
        super().__init__(component=component, field=ComponentAttribute.id, ids=ids)
...
class ComparisonError(SingleFieldValidationError):
    ...
    def __init__(
        self, component: ComponentType, field: ComponentAttribute, ids: list[int], ref_value: "ComparisonError.RefType"
    ):
        super().__init__(component, field, ids)
...
class InvalidAssociatedEnumValueError(MultiFieldValidationError):
    ...
    def __init__(
        self,
        component: ComponentType,
        fields: list[ComponentAttribute],
        ids: list[int],
        enum: type[Enum] | list[type[Enum]],
    ):
        """
