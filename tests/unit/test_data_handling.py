...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            {CT.node: ComponentAttributeFilterOptions.relevant, CT.sym_load: [AT.p]},
            {
                CT.node: partial(columnar_array, component_type=CT.node, n_components=4, attributes=None),
                CT.sym_load: partial(columnar_array, component_type=CT.sym_load, n_components=3, attributes=[AT.p]),
            },
        ),
        pytest.param(
            {CT.node: None, CT.sym_load: [AT.p]},
            {
                CT.node: partial(row_array, component_type=CT.node, n_components=4),
                CT.sym_load: partial(columnar_array, component_type=CT.sym_load, n_components=3, attributes=[AT.p]),
            },
        ...
        pytest.param(
            {CT.node: [AT.p], CT.sym_load: [AT.p]},
            {
                CT.node: partial(columnar_array, component_type=CT.node, n_components=4, attributes=[AT.p]),
                CT.sym_load: partial(columnar_array, component_type=CT.sym_load, n_components=3, attributes=[AT.p]),
            },
        ),
    ],
