...
def load_data(component_type, is_batch, is_sparse, is_columnar):
    ...
    columnar_names = [ComponentAttribute.p_specified, ComponentAttribute.q_specified]
...
def test__get_raw_attribute_data_view(component, is_batch, is_columnar, is_sparse):
    ...
    if component == ComponentType.asym_load:
        assert data[ComponentAttribute.p_specified].shape[-1] == asym_dense_batch_last_dim
...
@pytest.mark.parametrize(
    ("component", "attribute"),
    [
        pytest.param(ComponentType.asym_load, ComponentAttribute.p_specified, id="asym_load-shape_missmatch"),
    ],
)
...
def test__get_raw_attribute_data_view_direct(component, is_batch, is_columnar, is_sparse):
    attribute = ComponentAttribute.p_specified
    schema = power_grid_meta_data[DatasetType.update][component]
    ...
    _get_raw_attribute_data_view(attribute_data, schema, ComponentAttribute.p_specified)


@pytest.mark.parametrize(
    ("component", "attr_data_shape", "attribute"),
    [
        pytest.param(ComponentType.asym_load, (2, 4, 3), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (1, 4, 3), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 5, 3), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 6, 3), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, 3, ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (3, 3), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 4, 3), ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (1, 4, 3), ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 5, 3), ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 6, 3), ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, 3, ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (3, 3), ComponentAttribute.q_specified, id="asym_load-columnar"),
        # sym component
        pytest.param(ComponentType.sym_load, 3, ComponentAttribute.p_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (3, 3), ComponentAttribute.p_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (4, 3), ComponentAttribute.p_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (4, 0), ComponentAttribute.p_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, 0, ComponentAttribute.p_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, 3, ComponentAttribute.q_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (3, 3), ComponentAttribute.q_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (4, 3), ComponentAttribute.q_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (4, 0), ComponentAttribute.q_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (0, 4), ComponentAttribute.q_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, 0, ComponentAttribute.q_specified, id="sym_load-columnar"),
    ],
)
...
@pytest.mark.parametrize(
    ("component", "attr_data_shape", "attribute"),
    [
        pytest.param(ComponentType.asym_load, (2, 4, 4), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 6, 4), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, 0, ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 0, 0), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 4, 0), ComponentAttribute.p_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 4, 4), ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 6, 4), ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, 0, ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 0, 0), ComponentAttribute.q_specified, id="asym_load-columnar"),
        pytest.param(ComponentType.asym_load, (2, 4, 0), ComponentAttribute.q_specified, id="asym_load-columnar"),
        # sym component
        pytest.param(ComponentType.sym_load, (2, 4, 4), ComponentAttribute.p_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (2, 4, 3), ComponentAttribute.p_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (0, 0, 1), ComponentAttribute.p_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (2, 4, 4), ComponentAttribute.q_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (2, 4, 3), ComponentAttribute.q_specified, id="sym_load-columnar"),
        pytest.param(ComponentType.sym_load, (0, 0, 1), ComponentAttribute.q_specified, id="sym_load-columnar"),
    ],
)
