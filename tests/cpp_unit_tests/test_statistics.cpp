...
TEST_CASE("Test statistics - accumulate") {
    ...
    SUBCASE("UniformRealRandVar<symmetric_t> | IndependentRealRandVar<symmetric_t>") {
        ...
        auto const check = []<typename T>() {
            ...
            CHECK(accumulate(measurements | take(0)).value == 0.0);
            CHECK(is_inf(accumulate(measurements | take(0)).variance));

            CHECK(accumulate(measurements | take(1)).value == measurements.front().value);
            CHECK(accumulate(measurements | take(1)).variance == measurements.front().variance);

            CHECK(accumulate(measurements | take(2)).value == doctest::Approx(7.0 / 5.0));
            CHECK(accumulate(measurements | take(2)).variance == doctest::Approx(3.0 / 25.0));

            CHECK(accumulate(measurements | take(3)).value == doctest::Approx(5.0 / 3.0));
            CHECK(accumulate(measurements | take(3)).variance == doctest::Approx(1.0 / 10.0));
        };
    ...
    SUBCASE("UniformRealRandVar<asymmetric_t>") {
        ...
        CHECK(accumulate(measurements | take(0)).value(0) == 0.0);
        CHECK(accumulate(measurements | take(0)).value(1) == 0.0);
        CHECK(accumulate(measurements | take(0)).value(2) == 0.0);
        CHECK(is_inf(accumulate(measurements | take(0)).variance));

        CHECK(accumulate(measurements | take(1)).value(0) == measurements.front().value(0));
        CHECK(accumulate(measurements | take(1)).value(1) == measurements.front().value(1));
        CHECK(accumulate(measurements | take(1)).value(2) == measurements.front().value(2));
        CHECK(accumulate(measurements | take(1)).variance == measurements.front().variance);

        CHECK(accumulate(measurements | take(2)).value(0) == doctest::Approx(7.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(1) == doctest::Approx(14.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(2) == doctest::Approx(3.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).variance == doctest::Approx(3.0 / 25.0));

        CHECK(accumulate(measurements | take(3)).value(0) == doctest::Approx(11.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(1) == doctest::Approx(19.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(2) == doctest::Approx(3.0 / 2.0));
        CHECK(accumulate(measurements | take(3)).variance == doctest::Approx(1.0 / 10.0));
    }
    ...
    SUBCASE("IndependentRealRandVar<asymmetric_t>") {
        ...
        CHECK(accumulate(measurements | take(0)).value(1) == 0.0);
        CHECK(accumulate(measurements | take(0)).value(2) == 0.0);
        CHECK(is_inf(accumulate(measurements | take(0)).variance(0)));
        CHECK(is_inf(accumulate(measurements | take(0)).variance(1)));
        CHECK(is_inf(accumulate(measurements | take(0)).variance(2)));

        CHECK(accumulate(measurements | take(1)).value(0) == measurements.front().value(0));
        CHECK(accumulate(measurements | take(1)).value(1) == measurements.front().value(1));
        CHECK(accumulate(measurements | take(1)).value(2) == measurements.front().value(2));
        CHECK(accumulate(measurements | take(1)).variance(0) == measurements.front().variance(0));
        CHECK(accumulate(measurements | take(1)).variance(1) == measurements.front().variance(1));
        CHECK(accumulate(measurements | take(1)).variance(2) == measurements.front().variance(2));

        CHECK(accumulate(measurements | take(2)).value(0) == doctest::Approx(7.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(1) == doctest::Approx(20.0 / 7.0));
        CHECK(accumulate(measurements | take(2)).value(2) == doctest::Approx(7.0 / 9.0));
        CHECK(accumulate(measurements | take(2)).variance(0) == doctest::Approx(3.0 / 25.0));
        CHECK(accumulate(measurements | take(2)).variance(1) == doctest::Approx(6.0 / 35.0));
        CHECK(accumulate(measurements | take(2)).variance(2) == doctest::Approx(2.0 / 9.0));

        CHECK(accumulate(measurements | take(3)).value(0) == doctest::Approx(11.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(1) == doctest::Approx(200.0 / 61.0));
        CHECK(accumulate(measurements | take(3)).value(2) == doctest::Approx(44.0 / 23.0));
        CHECK(accumulate(measurements | take(3)).variance(0) == doctest::Approx(1.0 / 10.0));
        CHECK(accumulate(measurements | take(3)).variance(1) == doctest::Approx(42.0 / 305.0));
        CHECK(accumulate(measurements | take(3)).variance(2) == doctest::Approx(4.0 / 23.0));
    }
    ...
    SUBCASE("UniformComplexRandVar<symmetric_t> | IndependentComplexRandVar<symmetric_t>") {
        ...
        auto const check = []<typename T>() {
            ...
            CHECK(accumulate(measurements | take(0)).value.real() == 0.0);
            CHECK(accumulate(measurements | take(0)).value.imag() == 0.0);
            CHECK(is_inf(accumulate(measurements | take(0)).variance));

            CHECK(accumulate(measurements | take(1)).value.real() == measurements.front().value.real());
            CHECK(accumulate(measurements | take(1)).value.imag() == measurements.front().value.imag());
            CHECK(accumulate(measurements | take(1)).variance == measurements.front().variance);

            CHECK(accumulate(measurements | take(2)).value.real() == doctest::Approx(7.0 / 5.0));
            CHECK(accumulate(measurements | take(2)).value.imag() == doctest::Approx(27.0 / 5.0));
            CHECK(accumulate(measurements | take(2)).variance == doctest::Approx(3.0 / 25.0));

            CHECK(accumulate(measurements | take(3)).value.real() == doctest::Approx(11.0 / 6.0));
            CHECK(accumulate(measurements | take(3)).value.imag() == doctest::Approx(30.0 / 6.0));
            CHECK(accumulate(measurements | take(3)).variance == doctest::Approx(1.0 / 10.0));
        };
        SUBCASE("UniformComplexRandVar<symmetric_t>") {
    ...
    SUBCASE("UniformComplexRandVar<asymmetric_t>") {
        ...
        CHECK(accumulate(measurements | take(0)).value(0).real() == 0.0);
        CHECK(accumulate(measurements | take(0)).value(1).real() == 0.0);
        CHECK(accumulate(measurements | take(0)).value(2).real() == 0.0);
        CHECK(accumulate(measurements | take(0)).value(0).imag() == 0.0);
        CHECK(accumulate(measurements | take(0)).value(1).imag() == 0.0);
        CHECK(accumulate(measurements | take(0)).value(2).imag() == 0.0);
        CHECK(is_inf(accumulate(measurements | take(0)).variance));

        CHECK(accumulate(measurements | take(1)).value(0).real() == measurements.front().value(0).real());
        CHECK(accumulate(measurements | take(1)).value(1).real() == measurements.front().value(1).real());
        CHECK(accumulate(measurements | take(1)).value(2).real() == measurements.front().value(2).real());
        CHECK(accumulate(measurements | take(1)).value(0).imag() == measurements.front().value(0).imag());
        CHECK(accumulate(measurements | take(1)).value(1).imag() == measurements.front().value(1).imag());
        CHECK(accumulate(measurements | take(1)).value(2).imag() == measurements.front().value(2).imag());
        CHECK(accumulate(measurements | take(1)).variance == measurements.front().variance);

        CHECK(accumulate(measurements | take(2)).value(0).real() == doctest::Approx(7.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(1).real() == doctest::Approx(14.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(2).real() == doctest::Approx(3.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(0).imag() == doctest::Approx(27.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(1).imag() == doctest::Approx(4.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(2).imag() == doctest::Approx(25.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).variance == doctest::Approx(3.0 / 25.0));

        CHECK(accumulate(measurements | take(3)).value(0).real() == doctest::Approx(11.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(1).real() == doctest::Approx(19.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(2).real() == doctest::Approx(9.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(0).imag() == doctest::Approx(30.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(1).imag() == doctest::Approx(5.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(2).imag() == doctest::Approx(27.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).variance == doctest::Approx(1.0 / 10.0));
    }
    ...
    SUBCASE("IndependentComplexRandVar<asymmetric_t>") {
        ...
        CHECK(accumulate(measurements | take(2)).value(0).real() == doctest::Approx(7.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(1).real() == doctest::Approx(20.0 / 7.0));
        CHECK(accumulate(measurements | take(2)).value(2).real() == doctest::Approx(7.0 / 9.0));
        CHECK(accumulate(measurements | take(2)).value(0).imag() == doctest::Approx(27.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).value(1).imag() == doctest::Approx(3.0 / 7.0));
        CHECK(accumulate(measurements | take(2)).value(2).imag() == doctest::Approx(43.0 / 9.0));
        CHECK(accumulate(measurements | take(2)).variance(0) == doctest::Approx(3.0 / 25.0));
        CHECK(accumulate(measurements | take(2)).variance(1) == doctest::Approx(6.0 / 35.0));
        CHECK(accumulate(measurements | take(2)).variance(2) == doctest::Approx(2.0 / 9.0));

        CHECK(accumulate(measurements | take(3)).value(0).real() == doctest::Approx(11.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(1).real() == doctest::Approx(200.0 / 61.0));
        CHECK(accumulate(measurements | take(3)).value(2).real() == doctest::Approx(44.0 / 23.0));
        CHECK(accumulate(measurements | take(3)).value(0).imag() == doctest::Approx(30.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).value(1).imag() == doctest::Approx(33.0 / 61.0));
        CHECK(accumulate(measurements | take(3)).value(2).imag() == doctest::Approx(96.0 / 23.0));
        CHECK(accumulate(measurements | take(3)).variance(0) == doctest::Approx(1.0 / 10.0));
        CHECK(accumulate(measurements | take(3)).variance(1) == doctest::Approx(42.0 / 305.0));
        CHECK(accumulate(measurements | take(3)).variance(2) == doctest::Approx(4.0 / 23.0));
    }
    ...
    SUBCASE("DecomposedComplexRandVar<symmetric_t>") {
        ...
        CHECK(accumulate(measurements | take(0)).real_component.value == 0.0);
        CHECK(accumulate(measurements | take(0)).imag_component.value == 0.0);
        CHECK(is_inf(accumulate(measurements | take(0)).real_component.variance));
        CHECK(is_inf(accumulate(measurements | take(0)).imag_component.variance));

        CHECK(accumulate(measurements | take(1)).real_component.value == measurements.front().real_component.value);
        CHECK(accumulate(measurements | take(1)).imag_component.value == measurements.front().imag_component.value);
        CHECK(accumulate(measurements | take(1)).real_component.variance ==
              measurements.front().real_component.variance);
        CHECK(accumulate(measurements | take(1)).imag_component.variance ==
              measurements.front().imag_component.variance);

        CHECK(accumulate(measurements | take(2)).real_component.value == doctest::Approx(7.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).imag_component.value == doctest::Approx(80.0 / 15.0));
        CHECK(accumulate(measurements | take(2)).real_component.variance == doctest::Approx(3.0 / 25.0));
        CHECK(accumulate(measurements | take(2)).imag_component.variance == doctest::Approx(1.0 / 15.0));

        CHECK(accumulate(measurements | take(3)).real_component.value == doctest::Approx(11.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).imag_component.value == doctest::Approx(270.0 / 55.0));
        CHECK(accumulate(measurements | take(3)).real_component.variance == doctest::Approx(1.0 / 10.0));
        CHECK(accumulate(measurements | take(3)).imag_component.variance == doctest::Approx(3.0 / 55.0));
    }
    ...
    SUBCASE("DecomposedComplexRandVar<asymmetric_t>") {
        ...
        CHECK(accumulate(measurements | take(0)).real_component.value(0) == 0.0);
        CHECK(accumulate(measurements | take(0)).real_component.value(2) == 0.0);
        CHECK(accumulate(measurements | take(0)).real_component.value(1) == 0.0);
        CHECK(accumulate(measurements | take(0)).imag_component.value(0) == 0.0);
        CHECK(accumulate(measurements | take(0)).imag_component.value(2) == 0.0);
        CHECK(accumulate(measurements | take(0)).imag_component.value(1) == 0.0);
        CHECK(is_inf(accumulate(measurements | take(0)).real_component.variance(0)));
        CHECK(is_inf(accumulate(measurements | take(0)).real_component.variance(1)));
        CHECK(is_inf(accumulate(measurements | take(0)).real_component.variance(2)));
        CHECK(is_inf(accumulate(measurements | take(0)).imag_component.variance(0)));
        CHECK(is_inf(accumulate(measurements | take(0)).imag_component.variance(1)));
        CHECK(is_inf(accumulate(measurements | take(0)).imag_component.variance(2)));

        CHECK(accumulate(measurements | take(1)).real_component.value(0) ==
              measurements.front().real_component.value(0));
        CHECK(accumulate(measurements | take(1)).real_component.value(1) ==
              measurements.front().real_component.value(1));
        CHECK(accumulate(measurements | take(1)).real_component.value(2) ==
              measurements.front().real_component.value(2));
        CHECK(accumulate(measurements | take(1)).imag_component.value(0) ==
              measurements.front().imag_component.value(0));
        CHECK(accumulate(measurements | take(1)).imag_component.value(1) ==
              measurements.front().imag_component.value(1));
        CHECK(accumulate(measurements | take(1)).imag_component.value(2) ==
              measurements.front().imag_component.value(2));
        CHECK(accumulate(measurements | take(1)).real_component.variance(0) ==
              measurements.front().real_component.variance(0));
        CHECK(accumulate(measurements | take(1)).real_component.variance(1) ==
              measurements.front().real_component.variance(1));
        CHECK(accumulate(measurements | take(1)).real_component.variance(2) ==
              measurements.front().real_component.variance(2));
        CHECK(accumulate(measurements | take(1)).imag_component.variance(0) ==
              measurements.front().imag_component.variance(0));
        CHECK(accumulate(measurements | take(1)).imag_component.variance(1) ==
              measurements.front().imag_component.variance(1));
        CHECK(accumulate(measurements | take(1)).imag_component.variance(2) ==
              measurements.front().imag_component.variance(2));

        CHECK(accumulate(measurements | take(2)).real_component.value(0) == doctest::Approx(7.0 / 5.0));
        CHECK(accumulate(measurements | take(2)).real_component.value(1) == doctest::Approx(20.0 / 7.0));
        CHECK(accumulate(measurements | take(2)).real_component.value(2) == doctest::Approx(7.0 / 9.0));
        CHECK(accumulate(measurements | take(2)).imag_component.value(0) == doctest::Approx(80.0 / 15.0));
        CHECK(accumulate(measurements | take(2)).imag_component.value(1) == doctest::Approx(20 / 25.0));
        CHECK(accumulate(measurements | take(2)).imag_component.value(2) == doctest::Approx(170.0 / 35.0));
        CHECK(accumulate(measurements | take(2)).real_component.variance(0) == doctest::Approx(3.0 / 25.0));
        CHECK(accumulate(measurements | take(2)).real_component.variance(1) == doctest::Approx(6.0 / 35.0));
        CHECK(accumulate(measurements | take(2)).real_component.variance(2) == doctest::Approx(2.0 / 9.0));
        CHECK(accumulate(measurements | take(2)).imag_component.variance(0) == doctest::Approx(1.0 / 15.0));
        CHECK(accumulate(measurements | take(2)).imag_component.variance(1) == doctest::Approx(3.0 / 25.0));
        CHECK(accumulate(measurements | take(2)).imag_component.variance(2) == doctest::Approx(6.0 / 35.0));

        CHECK(accumulate(measurements | take(3)).real_component.value(0) == doctest::Approx(11.0 / 6.0));
        CHECK(accumulate(measurements | take(3)).real_component.value(1) == doctest::Approx(200.0 / 61.0));
        CHECK(accumulate(measurements | take(3)).real_component.value(2) == doctest::Approx(44.0 / 23.0));
        CHECK(accumulate(measurements | take(3)).imag_component.value(0) == doctest::Approx(270.0 / 55.0));
        CHECK(accumulate(measurements | take(3)).imag_component.value(1) == doctest::Approx(55.0 / 65.0));
        CHECK(accumulate(measurements | take(3)).imag_component.value(2) == doctest::Approx(194.0 / 47.0));
        CHECK(accumulate(measurements | take(3)).real_component.variance(0) == doctest::Approx(1.0 / 10.0));
        CHECK(accumulate(measurements | take(3)).real_component.variance(1) == doctest::Approx(42.0 / 305.0));
        CHECK(accumulate(measurements | take(3)).real_component.variance(2) == doctest::Approx(4.0 / 23.0));
        CHECK(accumulate(measurements | take(3)).imag_component.variance(0) == doctest::Approx(3.0 / 55.0));
        CHECK(accumulate(measurements | take(3)).imag_component.variance(1) == doctest::Approx(6.0 / 65));
        CHECK(accumulate(measurements | take(3)).imag_component.variance(2) == doctest::Approx(6.0 / 47.0));
    }
}
