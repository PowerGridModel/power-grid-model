...
TEST_CASE("Test main model") {
    ...
    SECTION("Test id for wrong type") {
        MainModel main_model2{50.0};
    ...
    SECTION("Test calculate power flow") {
    ...
    SECTION("Test copy main model") {
        MainModel model_2{main_model};
        SECTION("Copied - Symmetrical") {
    ...
    SECTION("Test iterative calculation") {
        SECTION("Symmetrical") {
    ...
    SECTION("Test individual output (symmetric)") {
        ...
        SECTION("SymVoltageSensor, sym output") {
            main_model.output_result<true, Node>(res, sym_node.begin());
    ...
    SECTION("Test individual output (asymmetric)") {
        ...
        */
        ...
        SECTION("AsymVoltageSensor, asym output") {
        ...
        SECTION("SymVoltageSensor, asym output") {
            ...
            CHECK(sym_voltage_sensor_asym_output[0].u_angle_residual[0] ==
                  Catch::Approx(0.1 - asym_node[0].u_angle[0]));
            CHECK(sym_voltage_sensor_asym_output[0].u_angle_residual[1] ==
                  Catch::Approx(0.1 - asym_node[0].u_angle[1]));
            CHECK(sym_voltage_sensor_asym_output[0].u_angle_residual[2] ==
                  Catch::Approx(0.1 - asym_node[0].u_angle[2]));
    ...
    SECTION("Test linear calculation") {
        SECTION("Symmetrical") {
            auto const math_output = main_model.calculate_power_flow<true>(1e-8, 20, CalculationMethod::linear);
            main_model.output_result<true, Node>(math_output, sym_node.begin());
            main_model.output_result<true, Branch>(math_output, sym_branch.begin());
    ...
    SECTION("Test update load and shunt param") {
