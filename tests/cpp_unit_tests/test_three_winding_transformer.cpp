...
TEST_CASE("Test three winding transformer") {
    ...
    SUBCASE("Update inverse") {
        ...
        SUBCASE("status_1") {
            SUBCASE("same") { three_winding_transformer_update.status_1 = int_status(transformer.status_1()); }
            SUBCASE("different") { three_winding_transformer_update.status_1 = IntS{0}; }
            expected.status_1 = int_status(transformer.status_1());
        }

        SUBCASE("status_2") {
            SUBCASE("same") { three_winding_transformer_update.status_2 = int_status(transformer.status_2()); }
            SUBCASE("different") { three_winding_transformer_update.status_2 = IntS{0}; }
            expected.status_2 = int_status(transformer.status_2());
        }

        SUBCASE("status_3") {
            SUBCASE("same") { three_winding_transformer_update.status_3 = int_status(transformer.status_3()); }
            SUBCASE("different") { three_winding_transformer_update.status_3 = IntS{0}; }
            expected.status_3 = int_status(transformer.status_3());
        }
