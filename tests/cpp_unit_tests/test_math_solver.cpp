...
TEST_CASE("Test math solver") {
    ...
    */
    ...
    topo.source_buses = SparseIdxVector{IdxVector{0, 1, 1, 1}};
...
TEST_CASE("Short circuit solver") {
    ...
    topo_sc.source_buses = SparseIdxVector{IdxVector{0, 1, 1}};
    ...
    SUBCASE("Test fault on source bus") {
        ...
        topo_comp.source_buses = SparseIdxVector{IdxVector{0, 1}};
...
TEST_CASE("Math solver, zero variance test") {
    ...
    */
    ...
    topo.source_buses = SparseIdxVector{IdxVector{0, 0, 1}};
...
TEST_CASE("Math solver, measurements") {
    ...
    */
    ...
    topo.phase_shift = {0.0, 0.0};
    topo.branch_bus_idx = {{0, 1}};
    topo.source_buses = SparseIdxVector{IdxVector{0, 1, 1}};
    topo.shunt_bus_indptr = {0, 0, 0};
