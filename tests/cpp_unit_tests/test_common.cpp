...
static_assert(std::same_as<capture_by_value_or_const_reference_t<int>, int const>);
static_assert(std::same_as<capture_by_value_or_const_reference_t<int const>, int const>);
static_assert(std::same_as<capture_by_value_or_const_reference_t<int&>, int const&>);
static_assert(std::same_as<capture_by_value_or_const_reference_t<int&&>, int const&>);
static_assert(std::same_as<capture_by_value_or_const_reference_t<int const&>, int const&>);
...
static_assert(include_all(Idx{2}, std::move(Idx{3}))); // NOLINT(performance-move-const-arg)
} // namespace
} // namespace power_grid_model
