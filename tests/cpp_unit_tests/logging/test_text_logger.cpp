...
constexpr std::string msg_other() { return "other 1"; }
constexpr std::string msg_other_extra() { return "other 2"; }
constexpr std::string msg_flush_failed() { return "flush failed"; }
