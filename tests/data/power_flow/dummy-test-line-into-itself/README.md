...
4. The output of both scenarios should be the same, except for the lines into itself and shunts.
   For those, it is true that $p_{\text{line},\text{from}} = p_{\text{line},\text{to}} = \frac{1}{2}p_{\text{shunt}}$,
   $q_{\text{line},\text{from}} = q_{\text{line},\text{to}} = \frac{1}{2}q_{\text{shunt}}$,
   $s_{\text{line},\text{from}} = s_{\text{line},\text{to}} = \frac{1}{2}s_{\text{shunt}}$ and
   $i_{\text{line},\text{from}} = i_{\text{line},\text{to}} = \frac{1}{2}i_{\text{shunt}}$.
