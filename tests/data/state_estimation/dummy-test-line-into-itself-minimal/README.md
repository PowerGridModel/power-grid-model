...
# Minimal test case with line into itself
...
1. Create a single-node grid with a source
2. Add 4 components to the grid: 1 line into itself and 1 shunt, as well as sensors on them.
