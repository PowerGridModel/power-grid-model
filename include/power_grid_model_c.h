...
// POWER_GRID_MODEL_API is used for the public API symbols. It either DLL imports or DLL exports (or does nothing for static build)
// POWER_GRID_MODEL_LOCAL is used for non-api symbols.
