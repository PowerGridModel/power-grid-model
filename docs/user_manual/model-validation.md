...
power-grid-model is validated using multiple cases present in [/tests/data](../../tests/data) folder.
...
All the test cases can be found in [/tests/data/power_flow/pandapower](../../tests/data/power_flow/pandapower). 
