...
class CopyableAtomic : public std::atomic<T> { // NOSONAR(S3624)
  private:
  ...
  public:
    ...
    CopyableAtomic(CopyableAtomic const& other) noexcept : std::atomic<T>{other.load(copy_order)} {} // NOSONAR(S3624)
