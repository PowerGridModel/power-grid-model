...
class Branch3 : public Base {
  public:
    ...
    auto inverse(std::convertible_to<Branch3Update> auto update_data) const {
        ...
        set_if_not_nan(update_data.status_1, int_status(status_1_));
        set_if_not_nan(update_data.status_2, int_status(status_2_));
        set_if_not_nan(update_data.status_3, int_status(status_3_));
