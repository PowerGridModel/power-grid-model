...
constexpr MetaAttribute get_meta_attribute(size_t offset, char const* attribute_name) {
    ...
    return MetaAttribute{
        ...
        .compare_value = [](RawDataConstPtr ptr_x, RawDataConstPtr ptr_y, [[maybe_unused]] double atol,
                            [[maybe_unused]] double rtol, Idx pos) -> bool {
...
template <class StructType> constexpr MetaComponent get_meta_component(char const* component_name) {
    return MetaComponent{
        ...
        .create_buffer = [](Idx size) -> RawDataPtr { return new StructType[size]; }, // NOSONAR(S5025)
        .destroy_buffer =
