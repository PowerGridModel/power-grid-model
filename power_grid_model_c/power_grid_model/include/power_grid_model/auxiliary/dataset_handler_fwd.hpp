...
template <data_mutable_tag T> constexpr bool is_data_mutable = std::same_as<T, data_mutable_t>;

static_assert(data_mutable_tag<data_mutable_t>);
static_assert(data_mutable_tag<data_immutable_t>);
static_assert(is_data_mutable<data_mutable_t>);
static_assert(!is_data_mutable<data_immutable_t>);
...
template <indptr_mutable_tag T> constexpr bool is_indptr_mutable = std::same_as<T, indptr_mutable_t>;

static_assert(indptr_mutable_tag<indptr_mutable_t>);
static_assert(indptr_mutable_tag<indptr_immutable_t>);
static_assert(is_indptr_mutable<indptr_mutable_t>);
static_assert(!is_indptr_mutable<indptr_immutable_t>);

template <data_mutable_tag data_mutable, indptr_mutable_tag indptr_mutable>
    requires(is_data_mutable<data_mutable> || !is_indptr_mutable<indptr_mutable>)
