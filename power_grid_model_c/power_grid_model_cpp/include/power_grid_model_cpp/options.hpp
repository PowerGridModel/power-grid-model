...
class Options {
  public:
    ...
    void set_calculation_type(PGM_Options* opt, PGM_Idx type) { PGM_set_calculation_type(handle.get(), opt, type); }
    ...
    void set_symmetric(PGM_Options* opt, PGM_Idx sym) { PGM_set_symmetric(handle.get(), opt, sym); }
    ...
    void set_max_iter(PGM_Options* opt, PGM_Idx max_iter) { PGM_set_max_iter(handle.get(), opt, max_iter); }
    ...
    void set_threading(PGM_Options* opt, PGM_Idx threading) { PGM_set_threading(handle.get(), opt, threading); }
    ...
    static void set_tap_changing_strategy(PGM_Handle* provided_handle, PGM_Options* opt,
    ...
    static void set_experimental_features(PGM_Handle* provided_handle, PGM_Options* opt,
                                          PGM_Idx experimental_features) {
