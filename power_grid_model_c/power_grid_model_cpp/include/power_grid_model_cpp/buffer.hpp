...
public:
    ...
    Buffer(PGM_MetaComponent const* component, PGM_Idx size)
        : component_{component}, size_{size}, handle(),  
          buffer_{PGM_create_buffer(handle.get(), component, size), details::DeleterFunctor<&PGM_destroy_buffer>()} {};

    ~Buffer() = default;

    static void set_nan(PGM_Handle* provided_handle, PGM_MetaComponent const* component, void* ptr, PGM_Idx buffer_offset, PGM_Idx size) {
    ...
    static void set_value(PGM_Handle* provided_handle, PGM_MetaAttribute const* attribute, void* buffer_ptr, void const* src_ptr, PGM_Idx buffer_offset, PGM_Idx size, PGM_Idx src_stride) {
    ...
    void get_value(PGM_MetaAttribute const* attribute, void* dest_ptr, PGM_Idx buffer_offset, PGM_Idx dest_stride) const {
