 ...
 * @param n_components The number of component types in the input data
 * @param components A pointer to a char const* array consisting the name of each component.
 * For i-th component, components[i] should be a char const* string of the component name
 * @param component_sizes A pointer to an integer array specifying the size of each component.
 * For i-th component, component_sizes[i] specifies how many elements there are for this component.
 * @param input_data A pointer to a void const* array consisting the input data buffers.
 ...
 * @param n_components The number of component types you want to update.
 * @param components A pointer to a char const* array consisting the name of each component.
 * For i-th component, components[i] should be a char const* string of the component name.
 * @param component_sizes A pointer to an integer array specifying the size of each component.
 ...
 * @param update_data A pointer to a void const* array consisting the update data buffers.
 ...
 * @param n_output_components The number of components you want in the output.
 ...
 * @param output_components A pointer to a char const* array consisting the name of each output component.
 * For i-th component, output_components[i] should be a char const* string of the output component name.
 * @param output_data A pointer to a void* array consisting the output data buffers.
 ...
 * @param n_scenarios The number of scenarios in a batch calculation.
 * Note this argument is ignored if you set n_update_components = 0. Then the n_scenarios is always 1.
 * @param n_update_components The number of components you want to update in a batch calculation.
 * If you set n_update_components = 0, it means it is a one-time calculation instead of batch calculation.
 * @param update_components A pointer to a char const* array consisting the name of each update component.
 * For i-th component, update_components[i] should be a char const* string of the update component name.
 * @param n_component_elements_per_scenario A pointer to an integer array specifying
 ...
 * @param indptrs_per_component A pointer to an integer pointer array
